...
def configuration(parent_package='',top_path=None):
    ...
    config.add_extension(name='libvc9b_Ofast_gcc', sources=['vc9b.c'], extra_compile_args=['-Wall', '-Wextra', '-pedantic', '-Werror', '-march=native', '-Ofast', '-std=c11', '-fopenmp'], extra_link_args=['-fopenmp'])
